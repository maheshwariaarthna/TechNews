        ...
        <div class="row">
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive top_static_article_img" src="{{asset('/img/feature-top.jpg')}}"
                             alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-5">
                <div class="feature_static_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="{{asset('/img/feature-static1.jpg')}}" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-5">
                <div class="feature_static_last_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="{{asset('/img/feature-static2.jpg')}}" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
...
<div class="category_section mobile">
    <div class="article_title header_purple">
        <h2><a href="/category/mobile" target="_self">Mobile</a></h2>
    </div>
    <!----article_title------>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="top_article_img">
                    <a href="#" target="_self"><img class="img-responsive"
                                                               src="{{asset('/img/cat-mobi-left-1.jpg')}}" alt="feature-top">
                    </a>
                </div>
                <!----top_article_img------>
            </div>
            <div class="col-md-6">
                ...
                <div class="category_article_title">
                    <h2><a href="/Mobile/Airbnb launches photo-centric app for iPads and Android
                        tablets." target="_self">Airbnb launches photo-centric app for iPads and Android
                        tablets. </a></h2>
                </div>
    ...
    <div class="category_article_wrapper">
        <div class="row">
            @if(count($mobileNews)>0)
            @foreach($mobileNews as $mobileNew)
            <div class="col-md-6">
                <div class="media">
                    <div class="media-left">
                        <a href="/{{$mobileNew->category}}/{{$mobileNew->title}}">
                            <img class="media-object" src="{{asset('/img/cat-mobi-sm1.jpg')}}" alt="Generic placeholder image" />
                        </a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple">{{$mobileNew->category}}</span>

                        <h3 class="media-heading"><a href="/{{$mobileNew->category}}/{{$mobileNew->title}}" target="_self">
                            {{$mobileNew->title}}
                        </a></h3>
                        <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Aarthna Maheshwari</a></span>
    ...
    <p class="divider"><a href="/category/mobile">More News&nbsp;&raquo;</a></p>
</div>
<!-- Mobile News Section -->

<div class="category_section tablet">
    <div class="article_title header_pink">
        <h2><a href="/category/tablet" target="_self">Tablet</a></h2>
    </div>
    <!-- Mobile News Section -->

    <div class="category_article_wrapper">
        <div class="row">
            @if(count($tabletNews)>0)
                @foreach($tabletNews as $tabletNew)
                    <div class="col-md-6">
                        <div class="category_article_body">
                            <div class="top_article_img">
                                <a href="/{{$tabletNew->category}}/{{$tabletNew->title}}" target="_self">
                                    <img class="img-responsive" src="{{asset('/img/tab_top1.jpg')}}" alt="feature-top"/>
                                </a>
                            </div>
                            <span class="tag pink">
                                <a href="/category/{{$tabletNew->category}}" target="_self">{{$tabletNew->category}}</a>
                            </span>
                            <div class="category_article_title">
                                <h2><a href="/{{$tabletNew->category}}/{{$tabletNew->title}}" target="_self">{{$tabletNew->title}}</a></h2>
                            </div>
    ...
    <p class="divider"><a href="category/tablet">More News&nbsp;&raquo;</a></p>
</div>
<!-- Tablet News Section -->
...
<div class="category_section gadget">
    ...
    <div class="category_article_wrapper">
        <div class="row">
             @if(count($gadgetNews)>0)
                @foreach($gadgetNews as $gadgetNew)
                <div class="col-md-6">
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <a href="/{{$gadgetNew->category}}/{{$gadgetNew->title}}" target="_self">
                                <img class="img-responsive" src="{{asset('/img/gad_top1.jpg')}}" alt="feature-top">
                            </a>
                        </div>
                    <!-- top_article_img -->

                        <span class="tag black"><a href="/category/{{$gadgetNew->category}}" target="_self">{{$gadgetNew->category}}</a></span>

                        <div class="category_article_title">
                            <h2>
                                <a href="/{{$gadgetNew->category}}/{{$gadgetNew->title}}" target="_self">{{$gadgetNew->title}}</a>
                            </h2>
                        </div>
                    <!-- category_article_title -->

                        <div class="article_date"><a href="#">10Aug- 2015</a>, by: <a href="#">Aarthna Maheshwari</a></div>
                    <!----article_date------>
                        <div class="category_article_content">
                            {{$gadgetNew->summary}}
                        </div>
    ...
    <p class="divider"><a href="/category/gadget">More News&nbsp;&raquo;</a></p>
</div>
<!-- Gadget News Section -->

<div class="category_section camera">
    <div class="article_title header_orange">
        <h2><a href="/category/camera" target="_self">Camera</a></h2>
    </div>
    <!-- article_title -->
    @if(count($cameraNews)>0)
        @foreach($cameraNews as $cameraNew)
            <div class="category_article_wrapper">
                <div class="row">
                    <div class="col-md-5">
                        <div class="top_article_img">
                            <a href="/{{$cameraNew->category}}/{{$cameraNew->title}}" target="_self">
                            <img class="img-responsive" src="{{asset('/img/cam_left1.jpg')}}" alt="feature-top">
                            </a>
                        </div>
                <!-- top_article_img -->
                    ...
                    <div class="col-md-7">
                        <span class="tag orange">{{$cameraNew->category}}</span>
                        <div class="category_article_title">
                        <h2><a href="{{$cameraNew->category}}/{{$cameraNew->title}}" target="_self">{{$cameraNew->title}}</a></h2>
                        </div>
                <!-- category_article_title -->
...
<div class="category_section design">
    <div class="article_title header_blue">
        <h2><a href="/category/design" target="_self">Design</a></h2>
    </div>
    <!-- row -->

    <div class="category_article_wrapper">
        <div class="row">
            @if(count($designNews)>0)
                @foreach($designNews as $designNew)
                    <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="/{{$designNew->category}}/{{$designNew->title}}" target="_self">
                            <img class="img-responsive" src="{{asset('/img/design_top1.jpg')}}" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->

                    <span class="tag blue"><a href="/category/{{$designNew->category}}" target="_self">{{$designNew->category}}</a></span>

                    <div class="category_article_title">
                        <h2><a href="/{{$designNew->category}}/{{$designNew->title}}" target="_self">{{$designNew->title}}</a></h2>
                    </div>
                    <!-- category_article_title -->
    ...
    <p class="divider"><a href="/category/design">More News&nbsp;&raquo;</a></p>
</div>
<!-- Design News Section -->
</div>
<!-- Left Section -->
...
<div class="widget reviews m30">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="{{asset('/img/pop_right1.jpg')}}0" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
